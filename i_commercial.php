...
<h1>Liste propriétés commerciales</h1>
    <div class="gallery">
   ...
   <h1>Nos Experts dans l'Immobilier Commercial </h1>
        <div class="agents-gallery">
            <div class="agent">
                <img src="agent1.png" alt="Agent 1">
                <h4> Eric Bonneval </h4>
                <p>Expert en Immobilier Commercial</p>
                <a href="agent1.html" class="bouton">Voir le profil</a>
            </div>
            <div class="agent">
                <img src="agent2.png" alt="Agent 2">
                <h4> Jacques Clément </h4>
                <p>Expert en Immobilier Commercial</p>
                <a href="agent2.html" class="bouton">Voir le profil</a>
            </div>
            <div class="agent">
                <img src="agent3.png" alt="Agent 3">
                <h4>Vanessa Bordier</h4>
                <p>Expert en Immobilier Commercial</p>
                <a href="agent3.html" class="bouton">Voir le profil</a>
            </div>
            <div class="agent">
                <img src="agent13.jpg" alt="Agent 4">
                <h4> Marc Assin </h4>
                <p>Expert en Immobilier Commercial</p>
                <a href="agent13.html" class="bouton">Voir le profil</a>
            </div>
            <div class="agent">
                <img src="agent16.jpg" alt="Agent 5">
                <h4> Sophie Sticket </h4>
                <p>Expert en Immobilier Commercial</p>
                <a href="agent16.html" class="bouton">Voir le profil</a>
            </div>
        </div>
    </div>
